...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/omdarshan-4964", icon: Github },
  { label: "Twitter", href: "https://x.com/Omdarshan_jsx", icon: Twitter },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/omdarshanshindepatil", icon: Linkedin },
]
